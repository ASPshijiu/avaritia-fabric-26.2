...
| `neutron_pile` | 中子堆 | 实现中 | — | 不适用 | 实现中 | — | — |
| `neutron_nugget` | 中子粒 | 实现中 | — | 不适用 | 实现中 | — | — |
| `neutron_ingot` | 中子锭 | 实现中 | — | 不适用 | 实现中 | — | — |
