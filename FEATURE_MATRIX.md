...
| `singularity` | 奇点（数据驱动） | 实现中 | — | 不适用 | 实现中 | — | — |
...
|---|---|---|---|---|---|---|
| `obsidian` | 黑曜石 | 实现中 | — | 实现中 | 实现中 | — |
| `blue_ice` | 蓝冰 | 实现中 | — | 实现中 | 实现中 | — |
| `coal` | 煤炭 | 实现中 | — | 实现中 | 实现中 | — |
| `copper` | 铜锭 | 实现中 | — | 实现中 | 实现中 | — |
| `iron` | 铁锭 | 实现中 | — | 实现中 | 实现中 | — |
| `lapis_lazuli` | 青金石 | 实现中 | — | 实现中 | 实现中 | — |
| `redstone` | 红石 | 实现中 | — | 实现中 | 实现中 | — |
| `glowstone` | 荧石粉 | 实现中 | — | 实现中 | 实现中 | — |
| `gold` | 金锭 | 实现中 | — | 实现中 | 实现中 | — |
| `diamond` | 钻石 | 实现中 | — | 实现中 | 实现中 | — |
| `emerald` | 绿宝石 | 实现中 | — | 实现中 | 实现中 | — |
| `quartz` | 下界石英 | 实现中 | — | 实现中 | 实现中 | — |
| `amethyst_shard` | 紫水晶碎片 | 实现中 | — | 实现中 | 实现中 | — |
| `netherite` | 下界合金锭 | 实现中 | — | 实现中 | 实现中 | — |
